...
All the __PIFF Execution__ is written in Python language.
### What the box does ?

This part box of the Workflow nammed  __PIFF Execution__ is for (as its name suggests) the input XML verifiying and reading. We must therefore retrieve the values that interest us.
...
To execute the script __PIFF Execution__ correctly, we need to import Python libraries.
